...
class Traindataset(Dataset):
    def __init__(self, data_root='file_train_test_1.dat'):
...
train_dataset = Traindataset(data_root='file_train_test_1.dat')
train_loader = DataLoader(train_dataset, batch_size=1, shuffle=True, num_workers=0)

# define a test_dataset that reads the above sample data
class Testdataset(Dataset):
    def __init__(self, data_root='file_test_test_1.dat'):
...
test_dataset = Testdataset(data_root='file_test_test_1.dat')
...
# save the model:
torch.save(net.state_dict(), "saved_weights_oh_test1(0).pth")
